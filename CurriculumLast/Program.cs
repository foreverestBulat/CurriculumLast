...
while (true)
{
    ...
    switch (change)
    {
        case 1:
            ...
            if (curriculum.LaborIntensityOfCourse(selectedCourses, StaticBase.ListDegrees[code - 1].CreditsRequired, StaticBase.ListDegrees[code - 1].SpecialCoursesRequired))
            {
        ...
        case 2:
            ...
            curriculum.AddNewCourse(StaticBase.ListCourses.Count + 1, title, Convert.ToBoolean(intSpecCourse), lectureHours, practiseHours, Convert.ToBoolean(intHasExam), Convert.ToBoolean(intHasCoursePaper), numbers);
            continue;

        case 3:
            curriculum.PrintDegrees();

            Console.WriteLine("Напишите код степени, который хотите изменить");
            ...
            curriculum.ChangeDegree(code, change);
        ...
        case 4:
            ...
            curriculum.ChangeCourse(code, change);
            continue;
